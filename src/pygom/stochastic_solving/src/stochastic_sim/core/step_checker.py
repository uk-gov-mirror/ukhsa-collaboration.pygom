...
class JumpChecker(ABC):
    ...
    def check_states(self, proposal : Step, x_min, x_max):
        """
    ...
    def check_reactions(self, proposal : Step, thresholds):
        """
    ...
    @abstractmethod
    def is_legal(self, proposal : Step, x_min, x_max, thresholds):
        """
